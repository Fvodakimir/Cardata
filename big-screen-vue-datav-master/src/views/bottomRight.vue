  ...
  <div id="bottomRight">
    <div class="bg-color-black">
      <div class="d-flex pt-2 pl-2">
        ...
        <div class="d-flex">
          <span class="fs-l text mx-2"><h1 style="font-size: 27px">汽車排行榜</h1></span>
      ...
      <div class="row-list">
        <ul class="car_rank" style="width: 100%;height: 420px;overflow: auto">
          ...
          <li v-for="(car, index) in carData" v-bind:key="index">
            <div>{{car.rank}}</div>
...
#bottomRight {
  ...
  .chart-box {
    ...
    .row_list{
      list-style: none;
      .car_rank::-webkit-scrollbar{display:none;}
      }
    .car_rank {
      overflow: hidden; /* 或者根据需要设置其他样式来隐藏滚动条 */
    }
    .car_rank li {
      display: grid;
